...
rDownloadURL = {"main": "https://bitbucket.org/haremmahmud/x-ui/raw/master/main_xui_xoceunder.zip", "sub": "https://bitbucket.org/haremmahmud/x-ui/raw/master/sub_xui_xoceunder.zip"}
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://bitbucket.org/haremmahmud/x-ui/raw/master/release_22f.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://bitbucket.org/haremmahmud/x-ui/raw/master/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://bitbucket.org/haremmahmud/x-ui/raw/master/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://bitbucket.org/haremmahmud/x-ui/raw/master/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("X-UI 22f Ubuntu %s Installer - HaremMahmud" % rVersion, col.GREEN, 2)
    print(" ")
