...
rDownloadURL = {"main": "https://bitbucket.org/haremmahmud/bmtone/raw/master/main_xui_xoceunder.zip", "sub": "https://bitbucket.org/haremmahmud/bmtone/raw/master/sub_xui_xoceunder.zip"}
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://bitbucket.org/haremmahmud/bmtone/raw/master/release_22f.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://bitbucket.org/haremmahmud/bmtone/raw/master/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://bitbucket.org/haremmahmud/bmtone/raw/master/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
